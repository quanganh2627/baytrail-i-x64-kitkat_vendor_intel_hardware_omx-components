...
private:
    ...
    OMX_ERRORTYPE ComponentCleanup();
...
private:
    enum {
        ...
        INPORT_BUFFER_SIZE = 3110400,  /* 1284 K for max 1280 size for ME */
    ...
    android::Mutex *mLock;
    uint32_t mDMAVAOffset;
    struct SECBuffer mSglVideoBuffer;
    struct SECBuffer mSglMetadataBuffer;
};
